	...
	<div id="accordion">
		...
		<div class="card">
			...
			<div id="collapse109" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Märta<br />
					Det är en bra tanke men flytspackel får inte vara ytlager! <br />
					Du måste ha klinker, färg, laminat eller annat som täcker flytspacklet. <br />
					En annan sak är att ytan på flytspackel inte ser ut som betong, betong är levande medan flytspackel är jämngrå. <br />
					<a href="offert-flytspackel.php">
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse108">
					1 nov 2018
					Hej <br />
					En av våra entreprenörer säger att de ska lägga golv gips sedan flytspackla i badrummen, är det inte onödigt ?
					Högg bygghöjd jämfört med övriga rum. Räcker det inte o flytspackla?
					Detta är på mellanbjälklag vattenburen golvvärme finns ligger mellan läkt på golvet. Mvh EDDIE
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse107">
					1 okt 2018
					1) Hej igen nu har han flytspacklat och det vart inte eiktigt hundra procent rätt.<br />
					2) Han säger att han fixar det med fix ovanpå innan han lägger duken. Fungerar det?<br />
					Mvh Jenny
				 </a>
			</div>
			<div id="collapse107" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Jenny<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse106">
					30 sep 2018
					1) Har fått hjälp med att flytspackla golvet men han gjorde det helt plant. Sa att fallet ordnar han senare.<br />
					2) Jag är lite förbryllad och orolig att han tänkt göra det med fixen.<br />
					Mvh Jenny
				 </a>
			</div>
			<div id="collapse106" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Jenny<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse105">
					15 sept 2018
					1) Hej, Har takterrass ca 25 kvm med tjärpapp och trall. Dessvärre försumbar lutning. Kan man ta bort trallen och flytspackla direkt på tjärpappen? ’<br />
					2) Hur i så fall, med primer först? Behöver nog också armeringsnät också.<br />
					3) Tjärpappen ligger troligen på OSB skivor och är inte helt stabila.<br />
					4) Tack i förhand för svar. <br />/ Örjan
				 </a>
			</div>
			<div id="collapse105" class="collapse" data-parent="#accordion">
				<div class="card-body">
					1) Stort NEJ. Ingenting kommer att fastna i oljan.<br />
					2) Tyvärr.<br />
		...
		<div class="card">
			...
			<div id="collapse104" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Tomas<br />
					1) Ja, det kallas för häftbrygga. OBS att detta gäller Kiiltos produkter. Vi säljer Kiilto!<br />
					2) Är betongen ytsvag kan du göra detta annars så behöver inte göra det.<br />
					3) Bra beslut.<br />
					4) Ta och börja i den änden som ligger längst bort så att du kan fortsätta på nästa del när du vill. Så du slipper vänta på torkning.<br />
					5) Häftbrygga om det är fukt utifrån. Alltså nej.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse102">
					18 Juli 2018
					1) Hur lång tid måste jag vänta efter flytspackling (cirka 10 mm skikt) över el slinga till värmegolv innan jag lägger klinker (i fix)?<br />
					2) Skiljer olika fabrikat åt mycket? <br />
				 </a>
			</div>
			<div id="collapse102" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Gregor<br />
		...
		<div class="card">
			...
			<div id="collapse101" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Tomas<br />
					1) Är det 30 mm för att du ska komma i rätt nivå? Annars räcker 15 mm.<br />
					2) Ja.<br />
		...
		<div class="card">
			...
			<div id="collapse100" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Henrik<br />
					Om det är tätt emellan trägolvet så kan du lägga armeringsnät, fästprimer och sen minst 13 mm fiberarmerat flytspackel (på lägsta punkt). <br />
					Nu utgår vi ifrån att det inte är svikt i golvet. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse99">
					12 Juni 2018
					Hej. <br />Vi har en hall med klinkers på golvet som vi ej gillar. <br />
					Kan man lägga ett lager flytspackel / flytbetong över klinkersen och används det som slutgiltigt golv? <br />
					/Emelie
				 </a>
			</div>
			<div id="collapse99" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Emelie<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse98">
					4 April 2018
					Hej. <br />Kan man flytspackla i stuga som ibland har minusgrader. <br />
					Tack Lena
				 </a>
			</div>
			<div id="collapse98" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Lena<br />
		...
		<div class="card">
			...
			<div id="collapse97" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Anna<br />
					Ja det går att göra. Lägg på fästprimer och ta ett lättflytande flytspackel. <br />
					Du kan vänta 1 cm per dygn innan du lägger på ett nytt lager. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse96">
					3 Mars 2018
					Hej. <br />
					Jag har en fråga angående min flytspackling. Jag håller på att göra tvättstuga i min källare, Jag har fexxat bort färg från betongplatta och sedan primat ytan. <br />
					Sen dagen efter flytspacklade vi rummet på 12 kvm. Nu har det gått 3 månader och slytspacklet har några Sprickor i sig. <br />
					Jag undrar om det är något problem Att vi nu ska lägga klinker på det. Kommer det att klara sig? <br />
					Ingen golvvärme eller annan värme har varit på I rummet under torkningstiden. <br />
					Anledningen till att det tagit tid med klinker är att Plattsättare varit sjuk. <br />
					Tack på förhand, Emil
				 </a>
			</div>
			<div id="collapse96" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Emil<br />
					Lägg omgående på en plast på flytspacklet. Det har börjar överhärda! <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse95">
					...
					Föreligger risk för bom?
				 </a>
			</div>
			<div id="collapse95" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej J<br />
		...
		<div class="card">
			...
			<div id="collapse94" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej J<br />
					Det är bäst att ta bort det gamla spacklet, det sitter troligen inte så bra efter 50 år.<br />
		...
		<div class="card">
			...
			<div id="collapse93" class="collapse" data-parent="#accordion">
				<div class="card-body">
		...
		<div class="card">
			...
			<div id="collapse91" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Anonym<br />
					Om färgen lossar så kommer allt ovanpå att lossa! <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse90">
					...
					Måste öka ca 3-5 mm. <br />
					Mvh Göran
				 </a>
			</div>
			<div id="collapse90" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Göran<br />
					>Hej. Om man måste flytspackla i omgångar ska man då prima innan man lägger oå nytt?<br />
					Oftast ja, har du tillskjutande fukt ska du inte ha fästprimer emellan. OBS att det gäller Kiilto:s sortiment, men de flesta har samma rekommendationer. Läs på vad din tillverkare rekommenderar.
					>Lika så när man lägger klinker?<br />
					Ja.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse87">
					...
					Har jag rätt i att vi måste täta sprickorna (med vad?). Armeringsnät direkt på golvet (?). <br />
					Vilken tjocklek på flytspacklet? <br />
					mvh Niels
				 </a>
			</div>
			<div id="collapse87" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Niels<br />
					Fråga, är det svikt i golvet, antar att det inte är det.<br />
					>Ett par sprickor 2-3 mm, Det blir inte uppvärmt på vintern.<br />
					Är det mellan furugolvet, det ska tätas innan flytspackling.
					>Från svar på frågor här tror jag att vi kan använda flytspackel mellan furugolvet och klinker.<br />
					Ja. 12 mm om du inte ska ha elektrisk golvvärme, 15 mm med elektrisk golvvärme och minst 30 mm eller 15 mm ovan vattenburen slang. Armeringsnät ska användas. Vi utgår ifrån Kiilto och branschens rekommendationer här.
					<br />
					>Har jag rätt i att vi måste täta sprickorna (med vad?).<br />
					Ta det du har hemma, silikon eller något som hindrar flytspacklet att rinna igenom.<br />
					>Armeringsnät direkt på golvet (?).<br />
					Korrekt, sen innan flytspacklingen ska du ha fästprimer (den ska torka). Det gör inget om den hamnar på elkabeln.<br />
					>Vilken tjocklek på flytspacklet?<br />
		...
		<div class="card">
			...
			<div id="collapse86" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Magnus<br />
		...
		<div class="card">
			...
			<div id="collapse85" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Emil<br />
		...
		<div class="card">
			...
			<div id="collapse84" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Leonard <br />
					Kolla med att fukta plattorna, torkar de snabbt så är de sugande. <br />
		...
		<div class="card">
			...
			<div id="collapse83" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej <br />
		...
		<div class="card">
			...
			<div id="collapse82" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Gunnar<br />
					Du kan lägga flytspackel men måste ha en slityta ovanpå. <br />
		...
		<div class="card">
			...
			<div id="collapse80" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Kenneth<br />
					Om vi utgår från Kiiltos produkter så går det inte. <br />
					Vi rekommenderar att du skrapar ut fix (nästan inget vatten) på det rena betonggolvet. <br />
		...
		<div class="card">
			...
			<div id="collapse79" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Pontus<br />
					Du kan inte använda flytspackel som ytskikt. Det går att flytspackla men att du måste ha något slitlager ovanpå! <br />
		...
		<div class="card">
			...
			<div id="collapse75" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Jan<br />
		...
		<div class="card">
			...
			<div id="collapse74" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Sven-Erik<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse72">
					29 Aug 2016 <br />
					Hej skulle vilja flytspackla en hel våning på 80m2, det är källare under hela våningen. <br />
			...
			<div id="collapse72" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Fredrik<br />
					Enligt rekommendation så ska golvet vara så här:<br />
					Skivkonstruktionens böjstyvhet på golv ska minst motsvara en 22 mm golvspånskiva upplagd på stöd, med ett centrumavstånd på 300-600 mm. <br />
					Oavsett regelavstånd ska böjstyvheten förstärkas, så att inte fuktrörelser överförs till de keramiska skiktet.<br />
					Med ovan skrivet så gäller det att du uppnår detta i ditt golv. <br />
					En viktig del av flytspacklet är att det griper tag i underlaget, papper som du tänkte lägga ut gör att flytspacklet ligger löst ovanpå. <br />
					Det blir inte någon kontakt. Det är inte bra att göra så.<br />
					Golvgips mellan slangarna gör golvet svagt. Ej bra.<br />
					Mängden flytspackel är så här:<br />
					x) 5 mm armeringsnät<br />
					x) 20 mm slang<br />
					x) 15 mm ovan slangen<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse71">
					14 Aug 2016 <br />
					Hej, jag ska flytspacklat vårt lilla badrum. <br />
					Det är väldigt litet, 110*185cm Golvbjälklaget är väldigt grovt och ligger på under 60cc Jag har även tänkt att kottla i mellan bjälkarna. <br />
					Kan jag sen lägga 12mm golvspån, armeringsnät, elektrisk golvvärme och flytta upp det med 20mm fiberförstärkt spackel. <br />
					Kan det hålla? Vet att man förordar 22mm spån men det blir inte bra.
				 </a>
			</div>
			<div id="collapse71" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Jonas.<br />
		...
		<div class="card">
			...
			<div id="collapse70" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej.<br />
					Allting går men du bör inte göra detta.<br />
					1) Är det ett badrum så ska du tätskikta ovanpå flytspacklet, då ligger flytspacklet mellan 2 tätskikt. Det blir mögel.<br />
					2) Om du ska ha klinker ovan. Plastmattan reagerar med flytspacklet och det kan skikta sig, det blir tomrum och flytspacklet ligger som en egen kaka.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse69">
					6 juli 2016 <br />
					Hej! Kan man flytspacklet uppe på en tjärpappsyta. <br />
					Mvh A
				 </a>
			</div>
			<div id="collapse69" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Anders.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse68">
					30 maj 2016 <br />
					Hej kan man flytspakla på limad plastmatta?
				 </a>
			</div>
			<div id="collapse68" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Stefan.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse67">
					13 maj 2016 <br />
					Gjort i fel ordning:( Ska lägga klinker på golv i gästtoalett 1.3 m3. <br />
					Har redan rollat ut fuktskydd på träfibergolvet fick höra att man bör ha dött material på fiberskivan(golvgips alt flytspackel). <br />
					Vill inte att det ska bygga så mycket går det att flytspackla på fuktskyddet o fuktskydda igen? <br />
					Och i så fall vilket är minimum på tjoclleken på golvspacklet utan golvvärme. <br />
					Eller går det bra att lägga klinket på fiberskivan? <br />
					Mvh Jonas
				 </a>
			</div>
			<div id="collapse67" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Jonas.<br />
					Aja baja, bråttom! Läs på innan du öser på. <br />
					Tråkigt och dyrt, men bra att du upptäckt felet. Det är bara att riva och göra om.<br />
					Om du inte ska ha golvvärme så kan du ha golvgips (underlaget ska vara stumt och ingen golvbrunn) eller <br />
					fiberarmerat flytspackel (15 mm när du har elektrisk golvvärme eller 12 mm utan golvvärme) med armeringsnät.<br />
					Tätskikt ovanpå flytspacklet och det ska vara duk! Se vår nya långfilm om tätskikt på träbjälklag! <br />
					Rollbart tätskikt har du när det är betong i golv och vägg.<br />
					Låg bygghöjd vill de flesta ha men gör det ordentligt så golvet håller. <br />
					Annars bör man inte göra något. <br />
					Chansa inte. Tätskikt, flytspackel och sen tätskikt är inte bra, det kan bli mögel. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse66">
					12 maj 2016 <br />
					Hej! Vi tänkte lägga vattenburen golvvärme i kök på träspånt. <br />
					Hur tjockt lager flytspackel behövs vid 10mm golvvärmerör. Alltså hur mycket behöver rören täckas. <br />
					Har hört 25mm men skulle vilja komma ner i bygghöjd så mycket som möjligt. <br />
					Har tänkt armeringsnät mot golvbrädorna, men undrar om man även små använda fiberarmerat flytspackel? <br />
					Vänligen Olof
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse65">
					7 maj 2016 <br />
					Jag vill flyta mig garage golv, men jag det blir olika mycket vad är det tunnaste jag kan lägga vill inte bygga på för mycket Peter
				 </a>
			</div>
			<div id="collapse65" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Peter.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse64">
					23 april 2016 <br />
					Hej, Håller på att bygga ett förråd men ser att de som gjutit golvet gjort för tunt på ena kortsidan – bl a sticker småstenar upp. <br />
					Nu har hantverkarna föreslagit att det skall fixa till detta med flytspackel. <br />
					Går det eller skall jag propsa på något annat? Hälsningar Elisabeth
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse63">
					13 april 2016 <br />
					Hej, Vi har ett betong golv i uterummet. <br />
					Nu vill vi flyta golvet för att få en snygg yta. <br />
					Måste det behandlas/slipas efter golvet är flytet?<br /> MVH Magnus
				 </a>
			</div>
			<div id="collapse63" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Magnus.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse62">
					13 april 2016<br /> Hej!<br />
					Vi har precis köpt en ny lägenhet och har en förhoppning att vi ska kunna fixa en hel del i den själva (min sambo är mer händig än jag!). <br />
					Vi vill bland annat lägga klinkers i hallen. <br />
					När vi tog bort det gamla trägolvet som låg där så är den först en spånskiva och sedan en sandbädd under. Nu undrar jag om ni har några råd hur vi ska gå till väga?<br />
					Sandbädden är djup och det är bara några få reglar i den. <br />
					Hur lägger vi klinkersen på detta? Kan vi flytspackla direkt på sandbädden? <br />
					Eller måste vi ta bort sanden först (oerhört mycket sand!)?<br />
					Tack för hjälpen!!<br />
					Vänliga hälsningar,<br />
					Sofia
				 </a>
			</div>
			<div id="collapse62" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Sofia.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse61">
					9 april 2016 <br />
					Hej! Vi står inför ett stort renoveringsprojekt och har fått in offerter från olika byggfirmor. <br />
					Det är flytt av kök, renovering av badrum och toalett samt golv som ska fixas. <br />
			...
			<div id="collapse61" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Lisa.<br />
					Flytspackel är för inbakning av golvvärmekablar / rör eller för att få golvet jämnt och rakt. <br />
					Om köket som ska bli sovrum och det nya kökets golv är raka så behövs inte flytspackel. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse60">
					16 mar 2016 <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse59">
					9 mar 2016 <br />
					Hej varför lägger man armerings nätet direkt på spån skivan är det inte bättre att ha den senterat i flytspacklet eller spelar det ingen roll ?
				 </a>
			</div>
			<div id="collapse59" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej.<br />
					Spånskivan rör sig med årstiden, varmt, fuktigt klimat osv. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse57">
					13 feb 2016 <br />
					Vi har haft en firma här och flytspacklat två blivande badrum på övervåningen. <br />
					Badrummen är 6kvm och 5,5 kvm. Spacklet är ca 3-4 cm ligger på en spånskiva med värmeslingor. <br />
					Utföraren sa att man inte använde armeringsnät på så små ytor utan man använder fiberspackel men nu har vi fått en spricka hela vägen ner, över i mitten av golvet i det ”större”badrummet. <br />
					Firman säger att man måste räkna med sprickor då vi bor i ett trähus, men vi känner oss väldigt osäkra på om vi ska gå vidare?
				 </a>
			</div>
			<div id="collapse57" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej.<br /> De flesta tillverkare ha samma konstruktionsuppbyggnad. <br />
					Tar vi Kiilto så skulle de inte godkänna detta badrum om du skulle reklamera golvet! <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse56">
					10 feb 2016 <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse54">
					6 jan 2016 <br />
					Hej,<br /> jag har rivit ut en gammal plastmatta ur min tvättstuga och planerar att lägga en ny plastmatta efter att jag bytt golvbrunn och byggt fall på golvet. <br />
					Under plastmattan låg masonitskiva som jag tagit bort eftersom den var full av lim. Nu är det en råspont som ligger på golvreglar med cc 400mm. <br />
					Har tänkt att flytspackla ett fall då hela sponten är plan bortsett från närmast golvbrunnen men min fråga är vad man behöver för underlag för flytspacklet? <br />
					Kan man spackla direkt på råsponten eller behöver man lägga en skiva först? Fungerar golvgips med flytspackel?<br /> MVH / Rikard
				 </a>
			</div>
			<div id="collapse54" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Rikard. <br />
					Det går att flytspackla om det är tätt mellan råsponten och att det inte är svikt i golvet. <br />
					Har du svikt så kan du lägga en 22 mm golvspånskiva. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse53">
					21 dec 2015 <br />
					Jag har en Gillestuga med oisolerad betongplatta från 70-talet. <br />
					På den tänkte jag lägga 3cm frigolit rätt på plattan därpå kör jag armeringsnät samt ovan detta tvinnar jag fast 20mm golvvärmeslang med bultband. <br />
					Efter detta så flytspacklet jag in slang och armering som bygger Ca.25 med 30mm flytspackel därefter kakling. <br />
					Skulle gärna vilja ha lite synpunkter på ovan då jag inte har riktigt koll. <br />
					Finns det nått bättre material att isolera med då jag inte kan höja golvet mer? <br />
					Är det ok att endast flytspackla 30mm?<br /> Tack på förhand!
				 </a>
			</div>
			<div id="collapse53" class="collapse" data-parent="#accordion">
				<div class="card-body">
					...
					För din del blir det så här:<br />
					5 mm armeringsnät + slangen 20 mm + 15 mm ovan slangen = 40 mm flytspackel på lägsta punkt (om du har ett badrum så är lägsta punkt golvbrunnen <br />
		...
		<div class="card">
			...
			<div id="collapse52" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej, det skiljer sig från märke och sort. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse51">
					17 dec 2015 <br />
					Det låter som ett bra tillvägagångssätt. <br />
					Du skriver att nät måste användas. <br />
					Jag ska flytspackla ett litet badrumsgolv , lägga ner elslingor och spackla fall på befintligt betonggolv. <br />
					Ska jag armera med nät då?
				 </a>
			</div>
			<div id="collapse51" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Bengt. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse50">
					13 dec 2015 <br />
					Hej, Så fint att ni finns att fråga. <br />
					Vi har en lägenhet från 40-talet med betongbjälklag. <br />
					Vi har bilat upp för ett avloppsröd och det blev inte helt jämt med ifyllnaden av ny betong.<br />
					Min fråga är: Hur tunt kan man flytspackla på nästan helslät betong? <br />
					Vi vill ha så tunt som möjligt så golvet inte bygger, eftersom de nu ligger i liv med andra golv. tidigare har det legat en linolium matta direkt på betongen. <br />
					Det gäller två sovrum. 4×2 m och 4×2.5 m golvyta. <br />
					Vi tänkte måla som ytskikt i nuläget. Och i framtiden ev lägga en heltäckningsmatta.<br /> mvh Annelie
				 </a>
			</div>
			<div id="collapse50" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Annelie. <br />Vi är ett företag som säljer flytspackel (www.kakelplattan.se) och har daglig support till våra kunder. <br />
					Ibland är frågorna för generella och då kan vi inte ge svar men vi försöker att hjälpa till. <br />
					Angående din fråga, Det finns många olika sorters flytspackel och när det är helslät betong så måste flytspacklet få fäste. <br />
					Är det en slipad yta så måste du göra en häftbrygga med hjälp av fix, OBS att detta gäller Kiiltos produkter! <br />
					Häftbryggan gör du med hjälp av fix som du med lite vatten skrapar ut på betongen. Fixen fäster då i betongen och bildar en knottrig yta. <br />
					Den knottriga ytan får sen flytspacklet fäste i. Är det inte så slät yta kan du lägga på fästprimer men skicka ett foto på golvet så kan vi hjälpa dig. <br />
					Tunnheten på flytspacklet är beroende på vilken typ av flytspackel du vill välja. Vi har flytspackel som går mot noll i höjd men det kostar desto mera. <br />
					Ett populärt flytspackel är Flytspackel Fiber 25 kg den ligger på minst 5 mm. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse49">
					2 dec 2015 <br />
					Har en tvättstuga, där golvet är målat. <br />
					Behöver jämna till golvet så det lutar mot golvbrunnen. <br />
					Kan jag använda flytspackel? och i så fall skall det målade golvet behandlas på något sätt?
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse48">
					30 nov 2015 <br />
					Hej. Har ett källargolv som jag tänkte klinkra. Läste här att om det kan finnas fuktvandring i golvet så ska man inte använda primer utan skrapa ut fix. <br />
					Vad mena med skrapa? Lägga ut ett tunt lager över hela golvet? <br />
					Samma fix som jag sedan fäster plattorna med?
				 </a>
			</div>
			<div id="collapse48" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej. <br />
					Man tar ex Kiiltos lightfix och fuktar den lite och sen skrapar ut fixen med den platta sidan av fixkammen. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse46">
					29 nov 2015 <br />
					En fråga, är det ok att lägga armeringen uppe på en elsliga istället ? <br />
					Går mycket snabbare att limma kabeln än att köra med strikes.<br />
					Tack på förhand /Per
				 </a>
			</div>
			<div id="collapse46" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Per. <br />
					Armeringsnätet gör bäst nytta närmast spånskivan. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse45">
					26 nov 2015 <br />
					Hej! Vi har fått ytsprickor i betongplattan ungefär 2 mm tjocka och en av sprickorna är kanske 3-4 meter lång. <br />
					Måste man flytspackla innan man lägger golvklinkers för att förhindra att plattorna spricker i framtiden om betongplattans sprickor blir större?
				 </a>
			</div>
		...
		<div class="card">
			...
			<div id="collapse44" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Hans. <br />
					Generellt nej, men det finns flytspackel som fungerar som golvyta. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse43">
					19 nov 2015 <br />
					Hej! Köpte ett nyckelfärdigt hus 2007 och har nu påbörjar ovanvåningen. <br />
					Och har kommit till badrummet. <br />
					Avlopp o allt e klart, och där ligger idag golvspånskivor. <br />
					Kan man flytspacka direkt på det, eller ska man lägga golvgips först? <br />
					Tanken är även att vi ska ha elektrisk golvvärme…
				 </a>
			</div>
		...
		<div class="card">
			...
			<div id="collapse42" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Viktor. <br />
					En kvinna i klack väger mycket mera per ytenhet än en elefant! <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse41">
					20 okt 2015 <br />
					Hej! Håller på att fixa i källaren då vi har bytt värmesystem. <br />
					Dränerade för två år sedan och sedan dess är det knappt fuktigt i källaren. Ska flyta alla fyra rummen i källaren. <br />
					Det är en oisolerade platta av betong. <br />
					Kan jag använda ”vanligt” flyt/avjämnings eller behöver jag ett som klarar tillskjutande fukt dvs ett för utomhusbruk? <br />
					Med vänlig hälsning, Fredrik
				 </a>
			</div>
			<div id="collapse41" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Fredrik. <br />
					Du ska ha ett som tål tillskjutande fukt. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse40">
					18 okt 2015 <br />
					Hur kan man tillvrka flytspackel vad är ingredienser.
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse39">
					17 okt 2015 <br />
					När kan man måla på flytspackel.
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse38">
					2 okt 2015 <br />
					Hej. Finns det olika hårdhet i flytspackel? <br />
					Vi skall flytspackla innan vi installerar ett stort rullarkiv fyllt med böcker. <br />
					Det blir galet tungt! Kan det bli sättningar i flytspacklet? <br />
					Det är ju av stor vikt att rullarkivet är avvägt så inte vagnarna rullar av sig själva. <br />
					Tacksam för info.<br /> Mvh Erik
				 </a>
			</div>
			<div id="collapse38" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Erik. <br />
					Här är ett problem som vi får allt oftare, ingen anger telefonnummer eller e-post.<br />
					Vi hoppas bara att Ni ser detta via hemsidan. För att svara på frågan så finns det olika hårdhetsspackel. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse37">
					...
					Bör jag flyta hela ytan el räcker det med svackorna? Och isf hur många säckar o primer går det åt? <br />
					Tacksam för svar <br />Mvh Per
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse36">
					23 sep 2015 <br />
					Hej. Vill dubbelkolla att jag förstått rätt av er finfina spackelskola: <br />
					Vid läggning på betonggolv med el-värmeslinga, <br />
					så räcker det att den minsta nivån är totalt 15 mm (slinga + spackel) vid den del av slinga som ligger närmast golvbrunnen?<br /> Mvh Hannes
				 </a>
			</div>
			<div id="collapse36" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Hannes. <br />
					Har du betong så kan du gå ner till minimum 5 mm ovan golvkabeln. <br />
					Vi säljer Heatcoms golvvärme och den är 3 mm. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse35">
					17 sep 2015 <br />
					Hej Vi undrar om man kan lägga något under spackling så det inte rinne mellan väggar och springor. <br />
					Vi har ett gammalt glest trägolv på övervåning som inte är i våg <br />
					Alltså ett mycket lutande golv Med vänlig hälsning Elvy tel xxxxxxx<br />
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse34">
					31 Aug 2015<br /> Hej! <br />
					kan man flytspackla plastmatta? den är inte så jobbig att dra bort men limmet verkar vara jobbigt att få bort. mvh petter
				 </a>
			</div>
			<div id="collapse34" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Petter.<br /> Nej ta bort plastmattan. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse33">
					19 Aug 2015 <br />
					Hej skulle behöva jämna ut golvet i min gillestuga för att lägga parkett. <br />
					Det är betong som är målad. Måste jag slipa bort färgen först? <br />Mvh Marcus
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse32">
					18 Aug 2015 <br />
					...
					Kan jag till exempel flytspackla nu i höst och vänta med att lägga klinkler till våren? <br />
					2. Finns det olika flytspackel som har olika tålighet för frost? <br />
					3. Om jag flytspacklar nu i höst och väntar med klinker till våren, kan jag gå på golvet? <br />
					Jag menar inte använda utrymmet utan endast gå på det för att tillexempel dra el och sätta upp saker på väggar och så.
				 </a>
			</div>
			<div id="collapse32" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej. Ursäkta att Ni fick vänta någon dag. <br />
					1) Oftast inom någon dag. Vänta 1 cm per dag. Detta är viktigt vid tätskiktning. Du kan vänta till våren men undvik att smutsa ner ytan.<br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse31">
					10 Aug 2015 <br />
					Hej, vi håller på att bygga ett uterum (vår/höst) och har en betongplatta som grund. <br />
					Går det att flytspackla och därefter måla och använda detta som golv eller krävs ytterligare behandling för att detta ska vara möjligt? <br />
					Vilken flytspackel rekommenderar ni för att underlaget ska kunna bli golv efter målning? <br />Tack,
				 </a>
			</div>
			<div id="collapse31" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej.<br /> Om ni har tak och väggar som hindrar regn och snö så kan ni använda vilket flytspackel som helst. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse30">
					1 Aug 2015 <br />
					Har flytspacklat mitt badrumsgolv med ardex k75 ovanpå golvspånskiva,primer,armering och elgolvvärme,<br />
					dock blev det lite bakfall och lite för lite på vissa ställen,<br />
					kan jag prima om och lägga på ett lager till och isåfall hur fort efter jag gjort 1a ggn :)?
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse29">
					11 Juli 2015 <br />
					Skall lägga klinker i garaget som är målat med flingfärg skall all färg bort och flytspackla där däcken rullat in och prima sedan.
				 </a>
			</div>
			<div id="collapse29" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej.<br /> All färg ska bort. Om du flytspacklar på detta och att sen färgen lossar så kommer flytspacklet att följa med. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse28">
					...
					Hur ska jag göra . <br />
					Ska ja har Armering flytspackel i så fall vilken ska ja ha då Här kommer min xxxx@gmail.com <br />
					Så få ha bra dag på <br />Från Bengt.
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse27">
					9 Juli 2015 <br />
					Hej! Vi ska bygga ett uterum på en befintlig platta på 24 m2 som är mycket ojämn. <br />
					Här kommer några mer eller mindre dumma frågor: <br />
					1) Måste man slipa plattan först? Den har varit målad, men färgen är till hälften bortnött av väder och vind. <br />
					2) Vi ska ha vattenburen golvvärme med tunna isoleringsskivor som slangarna ligger i. <br />
					Ska man flytspackla både under (för att få plattan jämn) och ovanpå? <br />
					Det kommer läggas klinker. <br />
					3) Blir flytspacklet så jämnt och starkt att det går att ställa och fästa uterummets glaspartier direkt på det? <br />
			...
			<div id="collapse27" class="collapse" data-parent="#accordion">
				<div class="card-body">
					...
					Vikitig att plattan är större än 15 cm x 15 cm. Har du nu en annan fabrikant av skivor och slangar så ska du följa deras rekommendation.<br />
					3) Det låter som att du ska skruva fast fästen i golvet eller ? <br />
					Generellt så gäller detta för vattenburen golvvärme. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse26">
					6 Juli 2015 <br />
					Hej <br />Tänkte använda flytspackel för att få våra gjutna bangolfbanor släta. <br />
					Banorna ligger utomhus, Vilket flytspackel ska man använda då ? Mvh Mikael
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse24">
					...
					Vilket flytspackel behöver jag och kommer det hålla att en bil kör där. <br />Mvh Jonas
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse22">
					26 maj 2015 <br />
					Hej, Vårt blivande badrum är väldigt avlångt, 4 x 1,5m. Dusch/golvbrunn längst in. <br />
					Dörren är på motsatta sidan. Tänkte flytspackla med avstängningslist vid dusch längst in i rummet. <br />
					Oroar mig för hur jag ska nå bäst. (Och ta mig ut när det är klart  Känns som man bör börja hälla där det ska vara som tjockast, alltså vid dörren. <br />
					Fast känns på ett vis enklare att börja längst in i rummet och ta sig mot dörren… Hmm… <br />
			...
			<div id="collapse22" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej. <br />
					Du kan dela upp flytspacklingen i delmoment. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse21">
					24 april 2015 <br />
					Hej! 1) Hur vet man att flytspacklet är jämnt? <br />
					2) Hur lokaliserar man punkten som man utgår ifrån. <br />
					3) Hur mäter man att det blivit jämnt?
				 </a>
			</div>
			<div id="collapse21" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Ann-Marie. <br />
					1) Ta ett långt vattenpass som är rakt och lägg ovanpå. Vickar det eller att det blir springor undertill så är det inte rakt. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse20">
					...
					Tack på förhand <br />Med vänlig hälsning Niklas
				 </a>
			</div>
			<div id="collapse20" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Niklas. <br />
					Det är bra att du bara fuktspärrar vid duschen. Du kan använda rollbart tätskikt vid duschen (det är billigare) som inte andas om övriga rummet kan andas. <br />
					Det är bra att all vatten som kommer ifrån duschen går direkt ner i golvbrunnen.<br />
		...
		<div class="card">
			...
			<div id="collapse19" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Björn. <br />Det här är en riskkonstruktion som ingen vågar ta garanti på. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse18">
					27 mars 2015 <br />
					Hej, jag har fått en svacka på ett område på kanske 1-2kvm på min glättade garageplatta på ena sidan intill en golvbrunn där det
					var tänkt att vara fall mot golvbrunnen. <br />
					Det kan vara kanske 5-8mm som djupast där vatten står. <br />
					Det är i ett område där bilens däck rullar över. Går det att fixa
					till med flytspackel så att det håller för slitaget från dubbdäck?
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse17">
					...
					koppar Hur ska man göra med flytspacklet runt dessa rör? <br />
					Jag misstänker att det går bra att flytspackla ”in” plaströren, dvs bara låta flytspacklet omsluta dem? <br />
					Stämmer det? Kopparören däremot känns det som att de behöver lite luft runt omkring sig? <br />
					Hur åstadkommer man det lättast och säkrast, om det behövs? <br />
					Tacksam för svar. <br />Mvh, Tommy
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse16">
					15 feb 2015 <br />
					Hej. <br />Jag ska lägga spårad cellplast under golvvärmerören sedan jag tidigare rivit bort isloreingsull från betongytan. <br />
					Rören kommer således delvis ligga på spåren. <br />
					Behöver jag prima under cellplasten och finns det något jag bör tänka på inför flytspacklingen på cellplasten? <br />
					Jag tänkte flytspackla ca. 2 cm över rören.
				 </a>
			</div>
			<div id="collapse16" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Fästprimer hindrar fukten i flytspacklet att gå ner i underlaget. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse15">
					1 feb 2015 <br />
					Hej Jag tänkte spackla över en brunn i garaget. <br />
					Min fundering är hur blir det vid den tunnaste ytan mellan fallet och golvet. <br />
					Kommer att bli 1 mm tunt vid övergången? <br />
					Sedan har jag en special golvfärg/lack som är hård som tusan och undrar om det behövs någon speciell förberedelse innan jag primar. <br />
					Det är vattenburen golv-värme där idag i plattan och jag kommer att lägga en heltäckningsmatta på efteråt. <br />
					Alltså ingen truckkörning. Vad ska jag använda för flyttspackel.
				 </a>
			</div>
			<div id="collapse15" class="collapse" data-parent="#accordion">
				<div class="card-body">
					De vanligaste flytspacklet vi har och som är billigast behöver minst 5 mm på lägsta punkt. <br />
					Tar du ett som är mycket lättflytande och som är lite dyrare men mycket mera lättjobbat så är det minimum 3 mm. <br />
					Ta och lägg på minsta stället 3 mm. Det går åt mera men det blir starkare. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse14">
					27 jan 2015<br /> Jag tänkte flytspackla i ett badrum för att bygga fall och sedan lägga elvärmeslingor och på det klinker. <br />
					Är det Ok att först prima och sedan lägga flytspackel o över det lägga ett tätskikt. <br />
					Jag är funderar om man då bygger in fukten i flytspacklet? <br />
					Är primern underst vättentät och fungerar som ett tätskikt känns det inte helt Ok. <br />
					Överst tätt men under mot träet bopde träet kunna andas ut fukt som kan finnas kvar i flytspacklet. Eller???<br />
				 </a>
			</div>
			<div id="collapse14" class="collapse" data-parent="#accordion">
				<div class="card-body">
					...
					Däremot så finns det våtprimer och den är tät, men den ska ligga ovanpå flytspacklet. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse13">
					21 jan 2015 <br />
					Kan man lägga typ mjölkpapp eller liknande underst för att inte flytspacklet ska rinna ner mellan gliporna på råsponten?
				 </a>
			</div>
			<div id="collapse13" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Om det är springor i plankorna på golv blir det för svagt att spackla på. <br />
					Brädorna ska uppfylla samma böjstyvhet som 22 mm spånskiva. Brädorna bör sitta ihop i not och spånt. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse12">
					17 jan 2015 <br />
					Ska primern vara på spånskivan eller på flytspacklet ?
				 </a>
			</div>
			<div id="collapse12" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Det ska vara både och om du på flytspacklet ska lägga fix och plattor! <br />
					Primer har 3 egenskaper som gör flytspacklingen och plattsättningen bättre, därför ska du inte hoppa över detta. <br />
					...
					Detta kan även ske när det är för lite eller för utspädd primer. <br />
					Även låg temperatur kan förstöra. <br />
					Utifrån vad som är känt tycks huvudorsaken till uppsprickning och bom (luftfickor under flytspacklet) vara en kombination av för lite rengöring och starkt sugande underlag. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse11">
					14 jan 2015 <br />
					Kan man dö av flytspackel?
				 </a>
			</div>
			<div id="collapse11" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Om man får ett ton över sig så gör det ont. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse10">
					5 jan 2015 <br />
					Hur tjock kan man flytspackla över golvvärme slinga ( el ) utan att försämra värme förmågan från slinga ( ex. tjocklek för klinker ). <br />
					Mvh Mathias
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse8">
					24 dec 2014 <br />
					Kan flytspackel användas för att täta (vatten) ett altangolv där tätskiktet mellan betong och lättbetongskivor läcker. <br />
					Undrar husägare Sören
				 </a>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse7">
					30 nov 2014 <br />
					Kan man lägga flytspackel direkt på spårad spånskiva (vattenburen golvvärme)? <br />
					Eller behövs primning först?
				 </a>
			</div>
			<div id="collapse7" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Du måste prima först så att fukten håller sig i flytspacklet och inte sugs upp i spånskivan. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse6">
					3 nov 2014 <br />
					Hur avgör jag om en flytspacklad yta är torr nog för att beläggas med tätskikt inför sättning av klinkers ?
				 </a>
			</div>
			<div id="collapse6" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Sten. <br />Lättast är att gå på leverantörens rekommendationer, det står på flytspackeltexten. <br />
					Vi har ett spackel där man ska vänta 1-3 dagar. <br />
					3 dagar är när det är flytspacklat i tjocka skikt. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse5">
					10 okt 2014<br />
					Hur får man efter det man använt EPS betong en fullständigt jämn yta vid flytspackling? <br />
					För jag har använt mig av Schönox fiber flytspackel och ytan var väldigt omjämn efter det applicering av flytspacklingen.
				 </a>
			</div>
			<div id="collapse5" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Du skulle ha ett mera lättflytande flytspackel.<br /> Det finns olika viskositet på flytspackel. <br />
					Vi har sådant som man häller i ett hörn och rinner jämnt över ytan. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse4">
					21 aug 2014 <br />
					Hej, Jag har en hall där det är vattenburen golvvärme som ligger i en spåradspånskiva. <br />
					Tidigare så låg det en golvgips ovanpå och sedan klinker. <br />
					Nu har jag byggt ut hallen och rivit bort gamla klinkern och gilvgipsen och skall ersätta med nytt. <br />
					Min fråga är om man kan ersätta den gamla golvgipsen med flytspackel och vad man måste göra då samt hur tunnt kan jag lägga? <br />
					Min fundering var att lägga åldersbeständig plast och sedan spackla ca 6-7 mm om det räcker. <br />// Christian
				 </a>
			</div>
			<div id="collapse4" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej Christian <br />
					När det gäller vattenburen golvvärme så är det minst 15 mm flytspackel ovan slangen eller minst 30 mm flytspackel totalt. <br />
					Detta gäller de flesta märken. I ditt fall är det 30 mm flytspackel som gäller. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse3">
					10 aug 2014 <br />
					Vid gjutning av ett betonggolv har det på ca 2 m2 yta blivit en ungefär 10 mm djup svacka. I övrigt är betonggolvet plant. <br />
					1) Är det lämpligt att använda flytspackel för att jämna ut denna svacka? <br />
					2) Häller jag i så fall flytspackel bara i svackan, eller skall hela golvet som är ca 16 m2 stort täckas med flytspackel?
				</a>
			</div>
			<div id="collapse3" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Hej <br />
					1) Svar: Du kan använda flytspackel som går mot noll som minsta bygghöjd. De spackeltyper som går mot noll är oftast dyra men du behöver inte så mycket. <br />
					Oftast kan man använda fix för mindre ytor som detta. Vi brukar rekommendera flytfix och ska du ha klinker på detta så är det utmärkt med fix. <br />
		...
		<div class="card">
			<div class="card-header">
				<a class="card-link" data-toggle="collapse" href="#collapse2">
					25 juni 2014 <br />Flytspackel är väl skadligt? Det orsakade ju så många problem tidigare.
				 </a>
			</div>
			<div id="collapse2" class="collapse" data-parent="#accordion">
				<div class="card-body">
					Vi antar att du menar det kaseinhaltigt flytspackel användes under 70- och 80-talet. <br />
					Flytspackel med kasein tillsammans med fukt gjorde att kaseinet bröts ned och bildade bland annat ammoniak. <br />
		...
		<div class="card">
			<div class="card-header">
			  ...
			  2 april 2014 <br />Om kravet med 3 månaders torktid på betongen är svår att uppnå (ca 2,5 månad istället). <br />
			  Kan man mäta fukthalten i betongen för att ändå kunna flyta golvet ca 2cm och sedan någon dag senare, lägga klinker?
			</a>
		  </div>
